...
import { FallbackProvider, JsonRpcProvider, Wallet, WebSocketProvider, ethers } from 'ethers';
...
export class RegistryContract extends Contract {
  constructor(driver: JsonRpcProvider | FallbackProvider | WebSocketProvider | Wallet | undefined) {
