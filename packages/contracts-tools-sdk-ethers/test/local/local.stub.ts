...
import { ContractCallOptions } from '../../src/types';
import StorageAbi from './simple-storage.abi.json';

export const MULTICALL_ADDRESS = '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512';
export const SIMPLE_STORAGE_ADDRESS = '0x5FbDB2315678afecb367f032d93F642f64180aa3';
...
export class SimpleStorage extends Contract {
  constructor(
    driver: ethers.WebSocketProvider | ethers.Wallet | ethers.JsonRpcProvider | ethers.FallbackProvider | undefined,
  ) {
