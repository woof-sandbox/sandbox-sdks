...
describe("FormattingUtils", () => {
  test("formatTokenValue", () => {
    expect(FormattingUtils.formatTokenValue(1000n, 3)).toBe("1");
    expect(FormattingUtils.formatTokenValue(1234567890123456789n, 18)).toBe(
      "1.234567890123456789",
    );
    expect(FormattingUtils.formatTokenValue(5000000000000000000n, 18)).toBe(
      "5",
    );
    expect(FormattingUtils.formatTokenValue(1000000000n, 6)).toBe("1000");
  });
  ...
  test("formatCurrency", () => {
    ...
    expect(FormattingUtils.formatCurrency(987654321.123, "€")).toBe(
      "€987,654,321.12",
    );
  });
