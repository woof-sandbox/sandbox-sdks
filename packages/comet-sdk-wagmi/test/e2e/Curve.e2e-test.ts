...
import { Curve, IMarket} from "@woof-software/comet-sdk";
...
describe("Curve Methods", () => {
    ...
    test("should contain borrowPerYearInterestRateSlopeHigh", () => {
        const curve = curves[0]!;
        expect(curve.borrowPerYearInterestRateSlopeHigh, "borrowPerYearInterestRateSlopeHigh is missing").to.be.a("bigint");
        expect(curve.borrowPerYearInterestRateSlopeHigh, "borrowPerYearInterestRateSlopeHigh is not valid").greaterThan(0);
    });
});