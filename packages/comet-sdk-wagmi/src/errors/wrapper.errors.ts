export const ALLOW_FAILED = () =>
    new Error("Failed to allow bulker contract.");
...
export const TOKEN_NOT_APPROVED = (amount: bigint) =>
    new Error(`Insufficient token allowance. Need approval for at least ${amount.toString()}.`);
...
export const APPROVE_FAILED = () =>
    new Error("Failed to approve token.");

export const SUPPLY_FAILED = () =>
    new Error("Failed to supply to the market.");
