...
import {CometContract, ConfigControllerContract, Erc20Contract, wagmiConfig} from "../contracts";
...
export async function fetchMarket(
  ...
  const configControllerAddress = WagmiUtils.resultOrThrow<Address>(marketData[7]);
