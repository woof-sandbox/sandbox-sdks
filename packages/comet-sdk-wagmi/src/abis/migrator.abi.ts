export const migratorAbi = [{
    "inputs": [{
        ...
        "components": [{
            ...
            "name": "flashData",
            "type": "tuple"
        }], "internalType": "struct Migrator.InitialFlashData[]", "name": "initialFlashData", "type": "tuple[]"
    ...
    "inputs": [{"internalType": "address", "name": "asset", "type": "address"}, {
        ...
        "name": "comet",
        "type": "address"
    }], "name": "AssetNotSupportedInComet", "type": "error"
}, {
    "inputs": [{"internalType": "address", "name": "baseToken", "type": "address"}],
    ...
    "inputs": [{"internalType": "uint256", "name": "borrowBalance", "type": "uint256"}],
    ...
    "inputs": [{
        ...
        "name": "governance",
        "type": "address"
    }], "name": "GovernanceAlreadySet", "type": "error"
}, {
    "inputs": [{"internalType": "address", "name": "asset", "type": "address"}],
    "name": "InputZeroAssetAmount",
    "type": "error"
}, {
    "inputs": [{"internalType": "uint256", "name": "requiredAmount", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "flashAmount",
        "type": "uint256"
    }], "name": "InsufficientFlashAmount", "type": "error"
}, {
    "inputs": [{"internalType": "uint256", "name": "baseTokenMigrate", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "baseTokenBalance",
        "type": "uint256"
    }], "name": "InvalidBaseTokenAmount", "type": "error"
    ...
    "anonymous": false,
    "inputs": [{"indexed": true, "internalType": "address", "name": "baseToken", "type": "address"}, {
        "indexed": true,
        "internalType": "address",
        "name": "liquidityPool",
        "type": "address"
    ...
    "inputs": [{"indexed": true, "internalType": "address", "name": "user", "type": "address"}, {
        ...
        "name": "srcComet",
        "type": "address"
    }, {"indexed": true, "internalType": "address", "name": "trgComet", "type": "address"}],
    "name": "Migration",
    "type": "event"
}, {
    "anonymous": false,
    ...
    "inputs": [{"internalType": "address", "name": "srcComet", "type": "address"}, {
        "internalType": "address",
        "name": "trgComet",
        "type": "address"
    ...
    "inputs": [{"internalType": "address", "name": "srcComet", "type": "address"}, {
        ...
        "components": [{"internalType": "address", "name": "asset", "type": "address"}, {
            ...
            "name": "amount",
            "type": "uint256"
        }], "internalType": "struct Migrator.AssetData[]", "name": "assetsData", "type": "tuple[]"
    }, {"internalType": "uint256", "name": "flashAmount", "type": "uint256"}],
    "name": "partialMigrate",
    "outputs": [],
    "stateMutability": "nonpayable",
    ...
    "inputs": [{
        ...
        "components": [{"internalType": "address", "name": "liquidityPool", "type": "address"}, {
            "internalType": "bool",
            "name": "isToken0",
            "type": "bool"
        }], "internalType": "struct Migrator.FlashData", "name": "flashData", "type": "tuple"
    }], "name": "setFlashData", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    ...
    "inputs": [{"internalType": "uint256", "name": "fee0", "type": "uint256"}, {
        "internalType": "uint256",
        "name": "fee1",
        "type": "uint256"
